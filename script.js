...
<span class="text-read">Perfecto, le agradezco mucho que se haya comunicado con nosotros. Le recuerdo que le atendió ${nombreOperador}, ${tituloOperador} de Locatel. ${saludoCompleto} y  Hasta luego.</span>`;
    } else {
...
<span class="text-read">Perfecto. Siendo así, le agradezco mucho que se haya comunicado con nosotros. Le recuerdo que le atendió ${nombreOperador}, ${tituloOperador} de Locatel.${saludoCompleto} y  Hasta luego</span>`;
    }
